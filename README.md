...
graph TD
    ...
    API -->|4. Pull Real-time Draw Data| Scrapers[Public API & Web Scrapers]
...
4. **Automated Data Scraper:** ดึงผลรางวัลโดยอัตโนมัติจากแหล่งข้อมูลสาธารณะ (Public Data Sources) และสำนักข่าวออนไลน์ พร้อมระบบ Cold Start Auto-Seeding ที่จะดึงข้อมูลตั้งต้นทันทีเมื่อเปิดเซิร์ฟเวอร์
...
### 5. **สั่งซิงค์ข้อมูลหวยลาวพัฒนาล่าสุดจาก Source**
- **Endpoint:** `POST /api/v2/lottery/sync`
...
- [x] **Interactive Charts:** นำเทคโนโลยี Recharts มาใช้แสดงกราฟแนวโน้มแบบ Interactive อย่างเต็มรูปแบบ (เสร็จสิ้น)
- [x] **Dark/Light Mode:** รองรับการสลับธีมสีอย่างสมบูรณ์แบบครอบคลุมทุกหน้าจอ (เสร็จสิ้น)
